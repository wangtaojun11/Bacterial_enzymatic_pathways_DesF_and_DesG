...
# Load the data
```{r}
d1 <- read_csv("C:/UIUC documents/Androgen manuscript/Data and codes/Coculture_steroid metabolism.csv") #read the data
head(d1)
```
# define format
```{r}
...
print(p)
ggsave("C:/UIUC documents/Androgen manuscript/Data and codes/Figures/Coculture_steroid metabolism.pdf", height = 3.5, width = 4)
