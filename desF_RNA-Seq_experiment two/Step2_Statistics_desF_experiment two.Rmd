...
Group <- c("OHAD","OHAD","OHAD","DMSO","DMSO","DMSO")
targets$Group <- Group
targets
```
...
```{r}
colnames(abundance2)
new_order <- c("name","X12708_11B_OHAD1","X12708_11B_OHAD2","X12708_11B_OHAD3","X12708_dmso1","X12708_dmso2","X12708_dmso3")
