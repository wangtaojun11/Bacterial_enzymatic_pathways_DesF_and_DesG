---
title: "LNCaP_proliferation_overtime_11OHT"
author: "Taojun Wang"
date: "2024-01-07"
...
```{r}
d1 <- read_csv("LNCaP_proliferation_overtime_11OHT.csv") 
head(d1)
...
p_24h <- ggplot(d1_24h_summary, aes(x = Androgens, y = Relative_cell_proliferation, fill = Enzalutamide)) +
  ...
  format.A + labs(x="Androgens (10 nM)", y="Relative cell proliferation (24h)")
...
p_48h <- ggplot(d1_48h_summary, aes(x = Androgens, y = Relative_cell_proliferation, fill = Enzalutamide)) +
  ...
  scale_fill_manual(values = c( "#D95F02" ,"#7570B3" ,"#E7298A", "#66A61E", "#E6AB02", "#A6761D", "#666666","#1B9E77")) + 
  scale_color_manual(values = c( "black" ,"black" ,"#E7298A", "#66A61E", "#E6AB02", "#A6761D", "#666666","#1B9E77")) + ylim(0,2.5) + 
  format.A + labs(x="Androgens (10 nM)", y="Relative cell proliferation (48h)")
...
p_96h <- ggplot(d1_96h_summary, aes(x = Androgens, y = Relative_cell_proliferation, fill = Enzalutamide)) +
  ...
  scale_fill_manual(values = c( "#D95F02" ,"#7570B3" ,"#E7298A", "#66A61E", "#E6AB02", "#A6761D", "#666666","#1B9E77")) + 
  scale_color_manual(values = c( "black" ,"black" ,"#E7298A", "#66A61E", "#E6AB02", "#A6761D", "#666666","#1B9E77")) + ylim(0,2.5) + 
  format.A + labs(x="Androgens (10 nM)", y="Relative cell proliferation (96h)")
...
```{r}
LNCaP_cell_proliferation_overtime <- plot_grid(p_24h,p_48h,p_96h, labels=c("a", "b", "c","d"), ncol = 3, nrow = 1)
print(LNCaP_cell_proliferation_overtime)
ggsave("LNCaP_proliferation_overtime_11OHT.pdf", height = 3.5, width = 6 , useDingbats = FALSE)
