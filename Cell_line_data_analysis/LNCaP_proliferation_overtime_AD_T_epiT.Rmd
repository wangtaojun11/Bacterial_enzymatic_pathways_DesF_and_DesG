---
title: "LNCaP_proliferation_overtime_AD_T_epiT"
author: "Taojun Wang"
date: "2024-11-07"
...
```{r}
d1 <- read_csv("LNCaP_proliferation_overtime_AD_T_epiT.csv") 
head(d1)
```
...
```{r}
LNCaP_cell_proliferation_overtime <- plot_grid(p_24h,p_48h,p_96h, labels=c("a", "b", "c"), ncol = 3, nrow = 1)
print(LNCaP_cell_proliferation_overtime)
ggsave("LNCaP_proliferation_overtime_AD_T_epiT.pdf", height = 3.5, width = 8 , useDingbats = FALSE)
