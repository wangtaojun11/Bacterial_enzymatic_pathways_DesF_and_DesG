---
title: "Coculture_steroid metabolism"
author: "Taojun Wang"
date: "02/15/2024"
...
# Load the data
```{r}
d1 <- read_csv("C:/UIUC documents/Androgen manuscript/Nature Microbiology_Revision/Revised manuscript/Data and codes/Coculture_steroid_metabolism/Coculture_steroid_metabolism.csv") #read the data
head(d1)
```
# define format
```{r}
...
d1_summary <- d1 %>%
  ...
  summarise(
    ...
    SD = sd(Concentrations) # This avoids a grouped df warning in ggplot
  )
...
print(p)
ggsave("C:/UIUC documents/Androgen manuscript/Nature Microbiology_Revision/Revised manuscript/Data and codes/Coculture_steroid_metabolism/Coculture_steroid_metabolism.pdf", height = 3.5, width = 4)
